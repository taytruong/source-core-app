    ...
    <TooltipPrimitive.Portal>
      ...
      >
        ...
        <TooltipPrimitive.Arrow
          className={`bg-foreground z-50 size-2.5 translate-y-[calc(-3%-2px)] rounded-xs ${IsColorArrow ? 'fill-primary' : 'fill-slate-500'} `}
        />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  );
